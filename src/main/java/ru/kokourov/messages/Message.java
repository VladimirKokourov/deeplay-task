...
public class Message {
    public static final String MSG_TASK1_RES = "Наибольшие %d числа массива: ";
    public static final String MSG_TASK1_HELLO = "Программа вывода наибольших чисел массива приветствует Вас.";
    public static final String MSG_TASK1_INPUT_SIZE = "Введите размер массива.";
    public static final String MSG_TASK1_INPUT_SIZE_ERROR = "Это должно быть число больше %d:\n";
    public static final String MSG_TASK1_INPUT_ARRAY = "Отлично! Введите массив размерностью %d.\n";
